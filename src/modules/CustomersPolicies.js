...
export default function CustomersPolicies({navigation}) {
  ...
  const policies = [
    {poliza: "Póliza No°1", seguro: "Seguro de vida", vigencia: "20/02/2025", mensualidad: 200},
    {poliza: "Póliza No°2", seguro: "Seguro de viaje", vigencia: "30/03/2028", mensualidad: 800},
    {poliza: "Póliza No°3", seguro: "Seguro de gastos médicos", vigencia: "16/10/2025", mensualidad: 600},
    {poliza: "Póliza No°4", seguro: "Seguro de viaje", vigencia: "22/08/2026", mensualidad: 800}
  ];
          ...
          <View key={index} style={styles.card}>
            <View style={styles.cardContent}>
              <View style={styles.textContainer}>
                ...
                <Text><Text style={styles.label}>Vigencia: </Text>{policy.vigencia}</Text>
                <Text><Text style={styles.label}>Mensualidad: </Text>${policy.mensualidad}</Text>
              </View>
