...
export default function InsuranceQuote({ navigation }) {
  ...
  const API_URL = `http://192.168.107.160:3000/nar/cotizaciones/id/${idCotizacion}`;
      ...
      [
        { text: "Cancelar", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              setIsLoading(true);
              const response = await fetch(`http://192.168.107.160:3000/nar/cotizaciones/emitida/${idCotizacion}`, {
                method: 'PUT',
              });
