...
import { View, Text, TextInput, StyleSheet, TouchableOpacity, SafeAreaView, Platform, DatePickerIOS, DateTimePickerAndroid, ScrollView } from 'react-native';
      ...
      <ScrollView>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.infoCard}>
            <Text style={styles.infoCardText}>Datos del Titular</Text>
          </View>
          ...
          <View style={styles.inputContainer}>
            ...
            <TouchableOpacity onPress={Platform.OS === 'android' ? showDatePickerAndroid : () => setShowDatePicker(true)} style={styles.dateInput}>
          ...
          {!isHolderInsured && (
            <View style={styles.extraFormContainer}>
              <View style={styles.infoCard}>
                <Text style={styles.infoCardText}>Datos del Asegurado</Text>
              </View>
              <View style={styles.inputContainer}>
                <Text style={styles.label}>Nombre</Text>
                <TextInput placeholder="Nombre" style={styles.input} />
